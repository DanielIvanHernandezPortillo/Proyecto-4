...
var map;
  function initialize(){
	...
	var map = new google.maps.Map(document.getElementById('map-canvas'), my_options);
		    ...
		    var onMarkerMouseOver = function() {
		      ...
		      infoWindow2.setContent('<h3>Mexico City, Distrito Federal</h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="http://en.wikipedia.org/wiki/Mexico_city"><img src="images/Mexico.jpg " /></a>');
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      ...
		      infoWindow2.setContent('<h3>Salamanca, Guanajuato </h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+ '<br><h3>Site Type: Oil</h3> <br><br><a href="https://es.wikipedia.org/wiki/Salamanca_(M%C3%A9xico)"><img src="images/salamanca.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      ...
		      infoWindow2.setContent('<h3>Monterrey, Nuevo Leon</h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Monterrey"><img src="images/Monterrey.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      var latLng = this.getPosition();
		      infoWindow2.setContent('<h3>Veracruz, Veracruz  </h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Veracruz"><img src="images/veracruz.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      var latLng = this.getPosition();
		      infoWindow2.setContent('<h3>Tampico, Tamaulipas </h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Tampico"><img src="images/tampico.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      var latLng = this.getPosition();
		      infoWindow2.setContent('<h3>Villahermosa, Tabasco</h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Tabasco"><img src="images/tabasco.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
 ...
 google.maps.event.addListener(mkr, 'mouseover', onMarkerMouseOver);
		    ...
		    var onMarkerMouseOver = function() {
		      var latLng = this.getPosition();
		      infoWindow2.setContent('<h3>Poza Rica de Hidalgo, Veracruz</h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Poza_Rica_de_Hidalgo"><img src="images/poza.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
		   ...
		   var mkr = new google.maps.Marker({
		    ...
		    var onMarkerMouseOver = function() {
		      var latLng = this.getPosition();
		      infoWindow2.setContent('<h3>Ciudad Victoria, Tamaulipas</h3>Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+'<br><h3>Site Type: Oil</h3><br><br><a href="https://es.wikipedia.org/wiki/Tamaulipas"><img src="images/tamaulipas.jpg " /></a>');
		      infoWindow2.open(map, this);
		    };
		    google.maps.event.addListener(map, 'mouseout', function() {
		      infoWindow2.close();
